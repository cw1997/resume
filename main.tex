...
\begin{document}
    ...
    \datedsubsection{\textbf{RisingWave Labs（北京奇点无限数据科技有限公司）}| 前端开发}{远程 | 2024/05 \textasciitilde 2025/02}
        \begin{itemize}
    ...
    \datedsubsection{\textbf{PingCAP（北京平凯星辰科技发展有限公司）}| 前端开发}{北京，深圳，远程 | 2020/10 \textasciitilde 2024/04}
        \begin{itemize}
    ...
    \iconsection{graduation-cap}{教育经历}
        \datedsubsection{\textbf{台湾师范大学（NTNU）}|社会教育学系|\textit{教育学博士（在读）}}{2025/09 \textasciitilde 至今}
            \begin{itemize}
                \item 担任RA(Research Assistant)，协助教授进行实验进行AI+教育相关研究，使用Dify + Next.js技术栈
            \end{itemize}
        \datedsubsection{\textbf{台湾科技大学（NTUST）}|电子工程系|\textit{工学硕士}}{2021/09 \textasciitilde 2025/08}
            \begin{itemize}
                \item \textbf{光电及半导体组}。研究基于PCB电路板、半导体元件和各种新型材料设计毫米波空间滤波器/天线。获校级奖学金
            \end{itemize}
        \datedsubsection{\textbf{台湾科技大学（NTNST）}|电子工程系|\textit{工学学士}}{2018/09 \textasciitilde 2021/08}
            \begin{itemize}
            ...
            \end{itemize}
        \datedsubsection{\textbf{武汉船舶职业技术学院}| 软件技术专业| \textit{专科/高职}}{2015/09 \textasciitilde 2018/08}
            \begin{itemize}
                \item \textbf{主要学习Java/PHP等Web前后端开发相关技术}。担任班级学习委员，负责班级助教工作。获校级奖学金
            \end{itemize}

    \iconsection{list}{项目作品}
        \datedsubsection{\textbf{NTUST LIB}\textit{（手机APP）}}{https://library.ntust.edu.tw/p/405-1049-110462,c11171.php?Lang=zh-tw}
            \begin{itemize}
        ...
        \datedsubsection{\textbf{inetutils}\textit{（网络协议栈）}}{https://github.com/cw1997/inetutils}
            ...
            \end{itemize}
        \datedsubsection{\textbf{SDRAM Controller, SDRAM内存控制器}}{https://github.com/cw1997/SDRAM-Controller}
            \begin{itemize}
    ...
    \iconsection{history}{其它经历}
        ...
        \datedsubsection{\textbf{台湾科技大学 学生会| 干部}}{}
            \begin{itemize}
                \item \textbf{行政部门}财务部部长，\textbf{负责会计工作，编列预决算报表}。学权部部员，\textbf{协助学校分发意见调查表单、举办校园演唱会}。
